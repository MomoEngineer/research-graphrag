...
- `index/` – Offline-Hybrid-Index in **SQLite** (Source of Truth): Papers/Chunks (Schema **0.2.0**, inkl. `section_title`-Abschnitts-Provenienz seit Phase 4) + Graph/Communities (Phase 3); der **TF-IDF-Raum wird beim Laden deterministisch rekonstruiert** (keine serialisierten Modelle, Option B).
