...
| --- | --- | --- |
| A0 | Festlegungen fixiert. **Messpaket übergeben** (Wegwerf, außerhalb des Repos, nur lesend – am Mini-Korpus per Prüfsumme belegt): Abdeckung inkl. Stub-Lücke, Nachtrag und Laufbedarf, Identität, Kalibrierliste samt Auswertung, Sammelabfrage-Probe, Handproben-Vorlage. **Messung am realen Bestand steht aus** | dieser Block |
