...
│  ├─ eval_retrieval.py        # Hit@k/MRR gegen eval/retrieval-gold.json (Phase 7 / A4)
...
├─ eval/                       # Prüf-Fragen & Stichproben (pragmatische QS) + Gold-Set (Hit@k/MRR)
├─ pyproject.toml
├─ README.md
└─ Roadmap.md
```
