...
> gemessenen Treffern – für eine belastbare Whitelist zu wenig. Aus **Phase 10** sind **V1** und
> **V2** umgesetzt: Die Local Search hängt nicht mehr an **einem** Seed, sondern an den **Top-5**
...
> `communities`. Die abgeschlossenen Phasen 0–7
