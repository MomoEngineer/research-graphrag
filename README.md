...
> Betriebsthemen. Aus **Phase 9** sind **S0 (Machbarkeit)** und **S1 (Kandidatensuche)**
...
> gemessenen Treffern – für eine belastbare Whitelist zu wenig. Aus **Phase 10** ist **V1**
> umgesetzt: Die Local Search hängt nicht mehr an **einem** Seed, sondern an den **Top-5** der
> Chunk-Wertung, deren Chunk-Nachbarschaften per Rang-Fusion zusammengeführt werden – Hit
> 0,618 → **0,912**, MRR 0,532 → **0,654** bei **0 Regressionen** und unberührten übrigen Modi.
> `LocalSearchResult.seed` heißt dadurch `seeds`
> ([ADR 0021](docs/adr/0021-local-multi-seed-phase10.md)). Die abgeschlossenen Phasen 0–7
> sind mit allen Kennzahlen in der [Roadmap-Historie](docs/roadmap-historie.md) archiviert.
