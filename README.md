...
│  ├─ evaluation/             # Gold-Set, Kennzahlen, Modus-Lauf, Baseline (Phase 7 / A6)
│  ├─ keywords.py             # kuratierte Keyword-Politik (Phase 7 / A5)
│  └─ mcp_server/             # MCP-Server (stdio) mit Tools
├─ eval/                      # Prüf-Fragen & Stichproben (pragmatische QS) + Gold-Set und Baseline (Hit@k/MRR)
├─ pyproject.toml
├─ README.md
└─ Roadmap.md
```
