...
> Der aktive Plan umfasst noch die **Phasen 9–11** und **Phase 13** ([Roadmap](Roadmap.md)) – ein
> separat startbarer Online-Research-Modus, die Abarbeitung der quantitativ belegten
> Retrieval-Befunde, Betriebsthemen sowie **Referenz-Einträge ohne Volltext** (ein Paper hinter
> einer Bezahlschranke wird über DOI/arXiv-ID zu einem ausdrücklich unvollständigen
> Korpus-Eintrag). Aus **Phase 9** sind **S0 (Machbarkeit)** und **S1 (Kandidatensuche)**
