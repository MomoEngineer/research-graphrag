...
>
> **Wie es weitergeht:** Der aktive Plan umfasst die **Phasen 8–11** ([Roadmap](Roadmap.md)) – Korpus-Zufluss über einen Eingangsordner `new_papers/`, ein separat startbarer Online-Research-Modus, die Abarbeitung der quantitativ belegten Retrieval-Befunde und Betriebsthemen. Die abgeschlossenen Phasen 0–7 sind mit allen Kennzahlen in der [Roadmap-Historie](docs/roadmap-historie.md) archiviert.
...
> **Geplant (Roadmap [Phase 8](Roadmap.md)):** Ein vorgelagerter Eingangsordner `new_papers/` mit
> Intake-Skript soll diesen Ablauf auf **einen** Befehl bündeln – inklusive Duplikatprüfung
> (sha256, dann DOI/arXiv) und automatisch ergänzter Entwurfszeile in [`Übersicht.md`](Übersicht.md).
> Der heutige Weg über `papers/` bleibt daneben bestehen. Die Schritt-für-Schritt-Anleitung wird
> hier ergänzt, sobald das Skript existiert – diese README beschreibt bewusst nur den
> **umgesetzten** Stand.
...
```
research-graphrag/
├─ new_papers/                 # Eingangsordner für den Intake (geplant, Roadmap Phase 8)
