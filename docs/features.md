...
| **Local Search** | Startet an der besten Passage und erweitert um ähnliche Chunks sowie um Nachbarpaper aus dem Ähnlichkeitsgraphen | `search_local`, `--mode local` | [retrieval/local](../src/research_graphrag/retrieval/doc/local.md) | [0008](adr/0008-retrieval-and-query-router-phase4.md) |
...
| **DRIFT Search** | Wählt zuerst die passende Community und verfeinert innerhalb ihrer Mitglieder lokal | `search_drift`, `--mode drift` | [retrieval/drift](../src/research_graphrag/retrieval/doc/drift.md) | [0008](adr/0008-retrieval-and-query-router-phase4.md) |
