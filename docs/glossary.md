...
| **Local / Global / DRIFT / Basic Search** | GraphRAG-Suchmodi: Detail an Entitäten (Local), corpusweit über Community-Reports (Global), global + lokal verfeinert (DRIFT), Top-k-Vektorsuche auf Chunks (Basic). Im Offline-Hybrid nachgebildet (Basic ≈ TF-IDF-Top-k, Local ≈ Graph-Nachbarschaft, Global ≈ Community-Zusammenfassung, DRIFT ≈ Hybrid; [ADR 0005](adr/0005-graphrag-index-backend-open.md)). |
