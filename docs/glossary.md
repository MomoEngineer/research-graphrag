...
| **Canonical Paper JSON** | Kanonisches Zwischenformat je Paper (Schema 0.3.0): heuristische Section-Hierarchie, Chunk-IDs, Referenz-Abschnitt, DOI/arXiv-Identifikatoren, Seiten-Range/Section-Provenienz, Qualitätsflags. Bounding-Box-Provenienz ist zurückgestellt ([ADR 0006](adr/0006-canonical-model-phase2-scope.md)). |
