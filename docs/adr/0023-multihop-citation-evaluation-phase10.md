...
| **Die Titel-Anfrage nimmt eine lexikalische Abkürzung.** | **22 von 33** Basic-Treffern und **24 von 42** Local-Treffern stammen aus **Referenz-Chunks** | Die Abkürzung wird nicht versteckt, sondern als **Diagnose** ausgewiesen (`…:ref` / `…:body`) |
