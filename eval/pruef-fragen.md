...
> **Status Phase 11 / B5:** Der Korpus ist von 145 auf **341** Paper gewachsen; beide Gold-Sets sind gegen diesen Stand **neu abgeleitet** (Retrieval-Gold **1.3.0** mit unveränderten Fragen und 34/34 nachrechenbaren Labels, Multi-Hop-Gold **113** statt 44 Anker), beide Baselines neu eingefroren. Für die **Sichtprüfung** dieses Sets ist ein Befund wichtig: Auf dem fakt-orientierten Gold-Set liefert **Local exakt dasselbe wie Basic** – alle Treffer stammen aus den Seeds. Das heißt aber **nicht**, dass der Fan-out nichts taugt: Auf der Multi-Hop-Ebene desselben Korpus steuert er 44 von 71 Treffern der Themen-Anfrage bei, und der Ähnlichkeitsgraph trifft die Zitationsnachbarschaft **fünfzehnmal** so oft wie eine Zufallsauswahl (Lift 15,09 gegen zuvor 8,20). Wer die Fragen des Abschnitts 3 (Fan-out) gegenliest, sollte beides kennen – der Unterschied liegt an der Fragestellung, nicht am Verfahren.
